  ...
  return (
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center bg-transparent text-white px-6 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        >
          Computer Science student specialized in secure full-stack development, robust database management, and predictive data modeling. Focused on bridging enterprise-ready software architecture with analytical problem-solving to protect and optimize scalable digital infrastructure. 
        </motion.p>
